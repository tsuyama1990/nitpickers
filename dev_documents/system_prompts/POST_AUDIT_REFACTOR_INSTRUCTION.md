...
1. **Global Vision** (`SYSTEM_ARCHITECTURE.md`): Ensure your cycle-level optimizations contribute to the global robustness of the system. Do not attempt to redesign the global architecture drastically, but finetune it to better fit the current cycle.
