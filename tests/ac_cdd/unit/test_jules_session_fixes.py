...
from jules_session_nodes import JulesSessionNodes, SessionStatus
from jules_session_state import JulesSessionState
...
async def test_monitor_session_batching() -> None:
    ...
    with patch("jules_session_nodes.httpx") as mock_httpx:
