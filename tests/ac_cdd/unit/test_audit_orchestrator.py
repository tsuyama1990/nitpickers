...
from domain_models import PlanAuditResult
from services.audit_orchestrator import AuditOrchestrator


@pytest.fixture
def mock_jules() -> Any:
    with patch("services.audit_orchestrator.JulesClient") as MockJules:
...
def mock_auditor() -> Any:
    with patch("services.audit_orchestrator.PlanAuditor") as MockAuditor:
