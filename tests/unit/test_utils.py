...
def test_check_api_key_no_keys(monkeypatch):
...
def test_check_api_key_google_only(monkeypatch):
...
def test_check_api_key_openrouter_only(monkeypatch):
...
def test_check_api_key_both_keys(monkeypatch):
